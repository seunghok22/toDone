...
const savedLang = isBrowser ? localStorage.getItem('todone-language') : null;
const browserLang = isBrowser && navigator.language ? (navigator.language.startsWith('ko') ? 'ko' : 'en') : 'en';
